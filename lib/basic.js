...
function BasicAdapter() {
    console.log('BasicAdapter constructor (superagent)');
}
...
//    console.log('BasicAdapter URL: ', parsedURL);
    ...
    serviceRequest.end(function (res) {
        ...
        var theBody = res.body;

        console.log('superagent response body', theBody);
        ...
        var extractions = extract(theBody, config.extract);
...
//var srcObj = {
//    name: 'chatUsersLoggedIn',
//    adapter: 'basic',
//    config: {
//        host: 'config.context.host' + 'config.context.port',
//        service: 'context',
//        account: '{{account}}',
//        realm: '{{realm}}',
//        path: 'users',
...
//
//var destObj = {};
//var theProp = "config.params.query";
//
//var theVal = getProperty(srcObj, theProp);
//console.log('got', theVal);
//
//if (theVal) {
//    setProperty(destObj, theProp, theVal);
//    console.log('set', JSON.stringify(destObj, null, 4));
//}
